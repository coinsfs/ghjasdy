...
var zerionWallet = ({
  ...
  return {
    id: "zerion",
    name: "Zerion",
    iconUrl: async () => (await import("./zerionWallet-35GMAYN4-VP5VGH24.js")).default,
    iconAccent: "#2962ef",
...
var zealWallet = ({
  ...
  id: "zeal",
  name: "Zeal",
  iconUrl: async () => (await import("./zealWallet-K7JBLVKT-H7SAXOBG.js")).default,
  iconBackground: "#fff0",
...
var tahoWallet = ({
  ...
  iconUrl: async () => (await import("./tahoWallet-BYONWLHD-5YUSLCYA.js")).default,
  downloadUrls: {
...
var talismanWallet = ({
  ...
  id: "talisman",
  name: "Talisman",
  iconUrl: async () => (await import("./talismanWallet-W5EQ26N7-ERZR3FX6.js")).default,
  iconBackground: "#fff",
...
var tokenaryWallet = ({
  ...
  id: "tokenary",
  name: "Tokenary",
  iconUrl: async () => (await import("./tokenaryWallet-FZ7BMUTO-KE4M266H.js")).default,
...
var tokenPocketWallet = ({
  ...
  return {
    id: "tokenPocket",
    name: "TokenPocket",
    iconUrl: async () => (await import("./tokenPocketWallet-UYD66DEM-6GPOLBYW.js")).default,
...
var trustWallet = ({
  ...
  return {
    id: "trust",
    name: "Trust Wallet",
    iconUrl: async () => (await import("./trustWallet-FST5ID2K-DALA53SB.js")).default,
...
var uniswapWallet = ({
  ...
  id: "uniswap",
  name: "Uniswap Wallet",
  iconUrl: async () => (await import("./uniswapWallet-JYAMZDQK-XMXLKL4P.js")).default,
...
var xdefiWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./xdefiWallet-QL7LCYNI-SHLNLKRU.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var walletConnectWallet = ({
  ...
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnectWallet-D6ZADJM7-TDD5MMSY.js")).default,
...
var oneKeyWallet = ({ chains }) => {
  ...
  return {
    ...
    iconAccent: "#00B812",
    iconBackground: "#fff",
    iconUrl: async () => (await import("./oneKeyWallet-FEYKOAOJ-Q4YXFAGR.js")).default,
    id: "onekey",
...
var phantomWallet = ({
  ...
  return {
    id: "phantom",
    name: "Phantom",
    iconUrl: async () => (await import("./phantomWallet-OLG36S4X-HV73GB3E.js")).default,
...
var rabbyWallet = ({
  ...
  id: "rabby",
  name: "Rabby Wallet",
  iconUrl: async () => (await import("./rabbyWallet-22VWIFCE-SLVA3LZY.js")).default,
...
var rainbowWallet = ({
  ...
  return {
    id: "rainbow",
    name: "Rainbow",
    iconUrl: async () => (await import("./rainbowWallet-GGU64QEI-K7VFCJ4O.js")).default,
...
var safeWallet = ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-DFMLSLCR-RR6N45E4.js")).default,
...
var safeheronWallet = ({
  ...
  iconUrl: async () => (await import("./safeheronWallet-YBMFXEUH-CZ6T5VGP.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var safepalWallet = ({
  ...
  return {
    id: "safepal",
    name: "SafePal Wallet",
    iconUrl: async () => (await import("./safepalWallet-FDJRNZUU-33I2ZFXC.js")).default,
...
var subWallet = ({
  ...
  return {
    id: "subwallet",
    name: "SubWallet",
    iconUrl: async () => (await import("./subWallet-ELA2UJOS-IZDPC7CQ.js")).default,
    iconBackground: "#fff",
...
var imTokenWallet = ({
  ...
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imTokenWallet-DMDOIZDQ-5XGVLITN.js")).default,
...
var injectedWallet = ({
  ...
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-EUKDEAIU-2GMHU6OI.js")).default,
  iconBackground: "#fff",
...
var ledgerWallet = ({
  ...
  iconAccent: "#000",
  name: "Ledger",
  iconUrl: async () => (await import("./ledgerWallet-DIS4VM6H-XOPIV2NB.js")).default,
  downloadUrls: {
...
var metaMaskWallet = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMaskWallet-ORHUNQRP-DHXEAXK4.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var oktoWallet = ({
  ...
  id: "Okto",
  name: "Okto",
  iconUrl: async () => (await import("./oktoWallet-3LTNTBG3-PYF6RIYD.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var mewWallet = ({
  ...
  return {
    id: "mew",
    name: "MEW wallet",
    iconUrl: async () => (await import("./mewWallet-4ZVF6HCJ-LBRC2YDC.js")).default,
    iconBackground: "#fff",
...
var okxWallet = ({
  ...
  return {
    id: "okx",
    name: "OKX Wallet",
    iconUrl: async () => (await import("./okxWallet-GKYMI2XW-EKIZMER5.js")).default,
    iconAccent: "#000",
    iconBackground: "#000",
    downloadUrls: {
...
var omniWallet = ({
  ...
  id: "omni",
  name: "Omni",
  iconUrl: async () => (await import("./omniWallet-VF54LPLK-LE4O4BG5.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var bitgetWallet = ({
  ...
  return {
    id: "bitget",
    name: "Bitget Wallet",
    iconUrl: async () => (await import("./bitgetWallet-JVNCB4EB-3LW4OVNF.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var desigWallet = ({
  ...
  return {
    id: "desig",
    name: "Desig Wallet",
    iconUrl: async () => (await import("./desigWallet-YZ4ZDEYW-L46QIPDX.js")).default,
    iconBackground: "#ffffff",
...
var bitskiWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./bitskiWallet-Y4QTLQPQ-KLVFZZZK.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var enkryptWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./enkryptWallet-LVMJVNXI-2433OG5D.js")).default,
    iconBackground: "#FFFFFF",
    downloadUrls: {
...
var dawnWallet = ({
  ...
  id: "dawn",
  name: "Dawn",
  iconUrl: async () => (await import("./dawnWallet-MN7QMTX3-IW7H5AT7.js")).default,
...
var foxWallet = ({
  ...
  return {
    id: "foxwallet",
    name: "FoxWallet",
    iconUrl: async () => (await import("./foxWallet-RFPGZZOK-UU7E4BMJ.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var frameWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./frameWallet-J2WUL2NQ-E56C7VJ3.js")).default,
...
var frontierWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./frontierWallet-3CNZ2ST5-TMUDBYBQ.js")).default,
...
var argentWallet = ({
  ...
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argentWallet-5OEFC7BD-2AHRZLH3.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var clvWallet = ({
  ...
  return {
    id: "clv",
    name: "CLV",
    iconUrl: async () => (await import("./clvWallet-RM4V57ZB-X6UUMBC5.js")).default,
    iconBackground: "#fff",
    iconAccent: "#BDFDE2",
...
var bifrostWallet = ({
  ...
  return {
    id: "bifrostWallet",
    name: "Bifrost Wallet",
    iconUrl: async () => (await import("./bifrostWallet-5VPKXMCJ-32BEV6UV.js")).default,
    iconBackground: "#fff",
...
var braveWallet = ({
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./braveWallet-BTBH4MDN-VCNWYUDB.js")).default,
    iconBackground: "#fff",
...
var coin98Wallet = ({
  ...
  return {
    id: "coin98",
    name: "Coin98 Wallet",
    iconUrl: async () => (await import("./coin98Wallet-7Q4WNBWR-DLKC5PMN.js")).default,
...
var coinbaseWallet = ({
  ...
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbaseWallet-2OUR5TUP-S6I4WGUN.js")).default,
    iconAccent: "#2c5ff6",
...
var coreWallet = ({
  ...
  return {
    id: "core",
    name: "Core",
    iconUrl: async () => (await import("./coreWallet-HRVLR2XS-D46RWCU7.js")).default,
